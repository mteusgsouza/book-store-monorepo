        ...
        <Sheet>
          ...
          <SheetContent side="right" className="w-64 pt-12">
            <nav className="flex flex-col gap-4">
              <Link href="#categorias" className="text-sm text-steel hover:text-ink transition-colors">
                Categorias
              </Link>
              <Link href="#produtos" className="text-sm text-steel hover:text-ink transition-colors">
                Lancamentos
              </Link>
